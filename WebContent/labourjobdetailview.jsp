											...
											<div class="form-content"> 
												<div class="form-group"> 
													<ul class="nav nav-tabs">
														<li role="presentation" class="active"><a href="labourjobdetailview.jsp?labourJobId=<%=labourJobId %>">Profile</a></li>
														<li role="presentation"><a href="jobdetailview.jsp?labourJobId=<%=labourJobId %>">Job Details</a></li>
													</ul>
													<table class="table table-responsive">
														<tr>
															<td><b>First Name</b></td> 
															<td>: <%=labourJobDetail.getFirstName() %></td>
														</tr>
														<tr>
															<td><b>Last Name</b></td>
															<td>: <%=labourJobDetail.getLastName() %></td>
														</tr>
														<tr>
															<td><b>Email</b></td>
															<td>: <%=labourJobDetail.getEmail() %></td>
														</tr>
														<tr>
															<td><b>Phone Number</b></td>
															<td>: <%=labourJobDetail.getPhone() %></td>
														</tr>
														<tr>
															<td><b>User Type</b></td>
															<td>: <%=labourJobDetail.getType() %></td>
														</tr>
													</table>
												</div> 
											</div>
